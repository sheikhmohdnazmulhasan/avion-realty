                        ...
                        <form className="px-5 pb-5 pt-3 lg:pb-10 lg:pt-5 lg:px-10" onSubmit={handleForgotPassword}>
                            ...
                            <div className="space-y-5">
                                ...
                                <div className="relative">
                                    <input defaultValue={email2} id="email_navigate_ui_modal" name='forgotEmail' type="email" required placeholder="example@gmail.com" className="block w-full rounded-lg p-3 pl-10 outline-none drop-shadow-lg  bg-gray-700 text-white" />
                            ...
                            <div className="  flex justify-end mt-6">
                                ...
                                <button type="submit" className=" flex gap-2 justify-center items-center py-2.5 px-3 rounded-lg drop-shadow-lg bg-gray-700 hover:bg-gray-800">
                                    {spinner && <div className="size-7 animate-[spin_2s_linear_infinite] rounded-full border-4 border-dashed border-[#d2991f]"></div>}
