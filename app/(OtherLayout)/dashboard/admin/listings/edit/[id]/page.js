        ...
        <div className="grid grid-cols-3 gap-12 ">
          ...
          <div>
            ...
            >
              ...
              <option selected value={data.propertyType}>
                {data.propertyType}
              </option>
          ...
          <div>
            ...
            >
              ...
              <option selected value={data.area}>
                {data.area}
              </option>
              {areas.map((area) => (
          ...
          <div>
            ...
            >
              ...
              <option selected value={data.views}>
                {data.views}
              </option>
              {views.map((view) => (
          ...
          {user?.data?.role === "admin" && (
            <div>
              ...
              >
                ...
                <option selected value={data.agent}>
                  {data.agent}
                </option>
                {agents.map((agent) => (
        ...
        <div className={data.status !== "Off-Plan" && "hidden"}>
          ...
          <div className="grid grid-cols-2 mt-4 gap-6">
            <div>
              ...
              <input
                required
                defaultValue={data?.payment?.firstInstallment}
                type="number"
            ...
            <div>
              ...
              <input
                required
                defaultValue={data?.payment?.underConstruction}
                type="number"
                placeholder="Place your payment in %"
            ...
            <div>
              ...
              <input
                required
                defaultValue={data?.payment?.onHandover}
                type="number"
                placeholder="Place your payment in %"
                name="onHandover"
                className="bg-black text-xs p-2 rounded-md mt-1 w-full border border-dotted "
            ...
            <div>
              ...
              <input
                required
                defaultValue={data?.payment?.postHandover}
                type="number"
                placeholder="Place your payment in %"
                name="postHandover"
                className="bg-black text-xs p-2 rounded-md mt-1 w-full border border-dotted "
                ...
                {previousFile.map((url, ind) => (
                  <div key={ind} url={url} className="relative">
                    ...
                    <div className="bg-white text-[#835C00] absolute p-1 border border-[#835C00] rounded-full -top-2 -right-3">
                      <MdClear
                        onClick={() => handleRemovePrevFile(url)}
                        size={20}
                        color="#835C00"
                      />
                    </div>
