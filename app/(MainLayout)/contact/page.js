        ...
        <div>
            ...
            <div className='md:flex mt-12 md:-mt-24 lg:-mt-48 mb-20 bg-[#0D0D0D] md:bg-transparent'>
                ...
                <div className='flex-1 relative mt-12 md:mt-0'>
                    ...
                    <div className='px-8 py-10 lg:py-16 shadow-md shadow-gray-700 bg-black w-1/2 lg:w-1/3 mt-12 md:mt-0 md:ml-16 lg:ml-28 z-20 absolute -top-12 right-4 md:-top-20 lg:-top-28 '>
