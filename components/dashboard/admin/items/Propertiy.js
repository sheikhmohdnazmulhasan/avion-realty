  ...
  async function handleDeleteItem(_id) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`https://www.avionrealty.ae/api/admin/items/property?id=${_id}`)
          .then((res) => {
            if (res.data.success) {
              Swal.fire({
                title: "Deleted!",
              ...
              mutate(`https://www.avionrealty.ae/api/admin/items/property`);
            }
          })
    ...
    if (isExist) {
      ...
      try {
        ...
        const serverResponse = await axios.post(
          "https://www.avionrealty.ae/api/admin/items/property",
          dataForBackend
        );
