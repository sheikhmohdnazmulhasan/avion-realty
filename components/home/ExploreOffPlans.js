...
const ExploreOffPlans = () => {
    ...
    return (
        <div className="">
            ...
            {/* slider  */}
            {
                currentIndex && (<div className="my-4 md:rounded-xl flex flex-col-reverse md:flex-row justify-between md:p-4 md:bg-[#171717] border border-[#E4B649] md:border-none ">
