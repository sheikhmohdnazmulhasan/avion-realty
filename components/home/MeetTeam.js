    ...
    return (
        <div>
                        ...
                        height : '342px'
                            ...
                            <div className="  bg-black opacity-70 absolute -bottom-1 w-full  z-20">
                                <div className="w-full text-center p-2">
                                    ...
                                    <p className='text-xs'>Languases : {agent.languagesSpeak}</p>
                                    <p className='text-xs'>Speciality : {agent.specializes}</p>
                                </div>
                            </div>
                        </div>
                    </div>  )
            ...
            <div className='hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-6'>
                {
                    agents?.map(agent => <div key={agent._id}>
                         <div className="relative">
                            ...
                            <div className="  bg-black opacity-70 absolute bottom-0 w-full hover:bg-transparent hover:opacity-100">
                                <div className="w-full text-center p-2">
                                    ...
                                    <p className='text-sm'>Languases : {agent.languagesSpeak}</p>
                                    <p className='text-sm'>Speciality : {agent.specializes}</p>
                                </div>
                            </div>
                        </div>
                    </div>)
