...
const MeetTeam = ({admin}) => {
  ...
  return (
    <div>
      ...
      <p className="px-4 md:px-0 lg:w-2/3 my-4 mx-auto md:text-xl md:text-center">
        Meet our team of experienced real estate agents at Avion Realty,
        specializing in helping you buy property in Dubai. Dedicated and
        knowledgeable,
      </p>

      {/* sm device slider */}
      <div className="md:hidden pt-8 w-full">
        {agents?.slice(currentIndex, currentIndex + 1).map((agent) => (
